                        ...
                        <div class="analysis-results">
                            <div class="row mb-4">
                                <div class="col-md-6 text-center">
                                    ...
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">BMI Score
                                    </div>
                                </div>
                                <div class="col-md-6 text-center">
                                    <div class="h3 mb-0 font-weight-bold" id="categoryValue">-</div>
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Health
                                        Category
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card border-left-warning shadow h-100 py-2">
                                        <div class="card-body">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="healthRiskValue">-
                                            </div>
                                        </div>
                                    </div>
                                </div>
