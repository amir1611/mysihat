...
@section('content')
            ...
            <tbody id="slotTableBody">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button"
                            class="btn btn-link btn-sm btn-rounded text-danger delete-slot-btn">Delete</button>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <<<<<<< HEAD <!-- Add/Edit Slot Modal -->
                ...
                <form action="{{ route('time-slots.store') }}" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Time Slots Multiselect Dropdown -->
                            <div class="form-group">
                                <label for="time_slot">Time Slots (Select multiple)</label>
                                <select class="form-control" name="time_slot[]" multiple required>
        ...
        <!-- Edit Slot Modal (similar to Add Slot Modal) -->
        <!-- Edit Slot Modal -->
                ...
                <form id="editSlotForm" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Time Slots Multiselect Dropdown -->
                            <div class="form-group">
                                <label for="edit_time_slot">Time Slots (Select multiple)</label>
                                <select class="form-control" id="edit_time_slot" name="time_slot[]" multiple required>
                                    <option value="10:00 AM">10:00 AM</option>
                                    <option value="11:00 AM">11:00 AM</option>
                                    <option value="12:00 PM">12:00 PM</option>
                                    <option value="01:00 PM">01:00 PM</option>
        ...
        <script>
            function editSlot(id) {
                $.get(`/time-slots/${id}/edit`, function(data) {
                    $('#edit_doctor_id').val(data.doctor_id);
                    $('#edit_date').val(data.date);
                    // Set the multi-select dropdown with selected time slots
                    let timeSlots = data.time_slot.split(
                        ','); // Assuming time slots are stored as comma-separated values
                    $('#edit_time_slot').val(timeSlots);
                    $('#editSlotForm').attr('action', `/time-slots/${id}`);
                    $('#editSlotModal').modal('show');
                });
            }
        </script>
        >>>>>>> b14b305 (Modify the time-slot feature)
    @endsection
