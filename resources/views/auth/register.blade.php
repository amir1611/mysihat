                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3" id="medical_license_container" style="display: none;">
                            <label for="medical_license_number" class="col-md-4 col-form-label text-md-end">{{ __('Medical License Number') }}</label>
                            <div class="col-md-6">
                                <input id="medical_license_number" type="text" class="form-control @error('medical_license_number') is-invalid @enderror" name="medical_license_number" value="{{ old('medical_license_number') }}">
